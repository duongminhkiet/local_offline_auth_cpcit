  ...
  Future<void> _loginOnlineAPI(String username, String password) async {
    ...
    if (isLoginAPISuccess && mounted) {
      ...
      if (autoResigterPin) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('Login online success and auto register pin success!'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isProcessingLoginApiOrOffline ? null : _handleLogin,
            ...
            OfflineAuthService.buildBiometricLoginButton(
              ...
              onSuccess: () => _navigateToHome(_usernameController.text), // Chỉ quan tâm khi thành công
            ),
              ...
              TextButton(
                onPressed: () async {
                  ...
                  if (username.isNotEmpty) {
                    await OfflineAuthService.clearOfflineAuthData(username: username);
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Enter username to remove offline data.')),
                    );
                  }
                },
